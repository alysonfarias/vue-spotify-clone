...
watchEffect(() => {
    console.log("🚀 ~ file: MenuItem.vue:20 ~ watchEffect ~ pageUrl.value:", pageUrl.value)
    console.log("🚀 ~ file: MenuItem.vue:20 ~ watchEffect ~ route.path:", route.path)
...
const isHover = () => {
    // console.log("🚀 ~ file: MenuItem.vue:28 ~ isHover ~ isHover:", isHover)
