  ...
  <div class="div">
    ...
    ">
      <div class="flex items-center ml-6">
        <button type="button" class="rounded-full bg-black p-[1px]">
          <ChevronLeft fillColor="#FFFFFF" :size-="30"></ChevronLeft>
        </button>
        <button type="button" class="rounded-full bg-black p-[1px] ml-4">
      ...
      <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items-center">
          <img class="rounded-full" width="27"
            src="https://media.licdn.com/dms/image/D4D03AQHY-ziWIcD0-A/profile-displayphoto-shrink_800_800/0/1696379423310?e=1706140800&v=beta&t=IwB_IVGK6UVgX6JGXbxJ6TvMZevqsmODJXz8SE3W6xc"
            alt="user-profile">
          <div class="text-white text-[14px] ml-1.5 font-semibold">Alyson Farias</div>
          <ChevronDown v-if="!openMenu" fillColor="#FFFFFF" @click="openMenu = true" :size-="25"></ChevronDown>
          <ChevronUp v-else="openMenu" fillColor="#FFFFFF" @click="openMenu = false" :size-="25"></ChevronUp>
        </div>
      </button>
      <span v-if="openMenu"
